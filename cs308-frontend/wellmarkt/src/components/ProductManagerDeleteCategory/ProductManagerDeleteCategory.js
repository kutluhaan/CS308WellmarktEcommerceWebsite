...
import "./ProductManagerDeleteCategory.css";
import DeleteCategoryForm from "../DeleteCategoryForm/DeleteCategoryForm";

const ProductManagerDeleteCategory = () => {
  ...
  return (
    <div className="admin-categories-container">
      <div className="form-container">
        <DeleteCategoryForm fetchCategories={fetchCategories} />
      </div>
...
export default ProductManagerDeleteCategory;
