...
const OrderManagement = () => {
  ...
  // Find product by ID from products context
          ...
          <div key={order.orderId} className="order-card-prodman">
            ...
            <div className="order-products-prodman">
              {order.products.map(product => {
                const productDetails = findProductById(product.productId); // Find product from context
                ...
                return (
                  <div key={product.productId} className="order-product-prodman">
                    ...
                    (<div>
                    <p><strong>Total Price: </strong>{product.quantity * (productDetails.price - (productDetails.price * (productDetails.discountPercent/100)))}</p>
                  </div>)
                  :
                  (<div>
                  <p><strong>Total Price: </strong>{product.quantity * productDetails.price}</p>
                </div>)}
