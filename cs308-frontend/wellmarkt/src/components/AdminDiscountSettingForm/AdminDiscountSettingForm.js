...
import "./AdminDiscountSettingForm.css";
import { toast } from 'react-hot-toast';
import apiClient from "../../api/axios";

const AdminDiscountSettingForm = () => {
  ...
  const setDiscount = async (productId, discount) => {
      ...
      const response = await apiClient.put('/admin/set-discount', null, {
        params: {
            productId,
            discount,
        },
...
export default AdminDiscountSettingForm;
