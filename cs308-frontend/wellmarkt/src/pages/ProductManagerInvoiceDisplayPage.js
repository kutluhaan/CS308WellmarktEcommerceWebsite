...
import ProductManagerInvoiceDisplay from '../components/ProductManagerInvoiceDisplay/ProductManagerInvoiceDisplay';
import SearchBar from '../components/SearchBar/SearchBar';

const ProductManagerInvoiceDisplayPage = () => {
  ...
  return (
    <div className="product-manager-invoices-display-page">
      <Navbar navElements={navElements} />
      <ProductManagerInvoiceDisplay/>
      <Footer />
    </div>
  );
};

export default ProductManagerInvoiceDisplayPage;