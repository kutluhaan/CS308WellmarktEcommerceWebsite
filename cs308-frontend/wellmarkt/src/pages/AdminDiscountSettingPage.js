...
import AdminDiscountSettingForm from "../components/AdminDiscountSettingForm/AdminDiscountSettingForm";
import SearchBar from "../components/SearchBar/SearchBar";

function AdminDiscountSettingPage () {
  const commonNavElements = [
    ...
    <SearchBar navigation={"/admin/set-discount"} />,
  ];
  ...
  return (
      <div className= "contact-page">
        ...
        <AdminDiscountSettingForm/>
        <Footer/> 
      </div>
    );
}
export default AdminDiscountSettingPage;